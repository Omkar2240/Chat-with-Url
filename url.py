...
# Set the Google API Key directly in the environment
API_KEY = "AIzaSyCqlhSOPwYzfnSz-apR6IWjQNwyqjX9dM0"  # Replace with your actual API key
...
def get_conversational_chain():
    ...
    If the answer is not in the provided context, just provide the answer of the question from the internet. Don't provide a wrong answer.
...
if st.sidebar.button("Get Answer"):
    if url and user_question:
        ...
        st.warning("Please provide both the URL and a question.")
